...
CONTAINS
   ...
   SUBROUTINE rst_opn( kt )
      ...
      IF( .NOT. ln_rst_list .AND. MOD( kt - nit000, nstock ) == 0 ) THEN   
         ! they use kt - 1 and not kt - nit000 to keep the same periodicity from the beginning of the experiment but
         !     it skips the first pring
         ! we use kt - nit000 and not kt - 1 so it is based on start of run and this actually works 
